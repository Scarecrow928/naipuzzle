  ...
  <Teleport to="body">
    <div v-if="showCredits" class="credits-overlay" @click.self="showCredits = false">
      <div class="credits-card animate-fade-in-scale">
        ...
        <br>
        <a class="credits-link" href="https://space.bilibili.com/11560942" target="_blank" rel="noopener">
          <img src="https://www.bilibili.com/favicon.ico" width="18" height="18" alt="" style="border-radius:2px" />
          Scarecrow928
        </a>
